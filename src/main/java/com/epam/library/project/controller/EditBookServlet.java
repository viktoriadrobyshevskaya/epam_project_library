...
public class EditBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ServiceException {
        ...
        int newAuthor = Integer.parseInt(request.getParameter("id_author"));
        String newYear = request.getParameter("book_author");
        int newCopies = Integer.parseInt(request.getParameter("book_author"));
